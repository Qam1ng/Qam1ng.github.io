...
Trained the Qijiang No.1 humanoid robot for straight-leg walking using PPO reinforcement learning, and implemented a Universal Virtual Component (UVC) controller for stable bent-leg walking — moving from manual tuning to learning-based control.

**Autonomous Self-Driving Wheelchair — UW ENGINE Capstone (Cyberworks Robotics)**
Built a robust, affordable autonomous navigation system for power wheelchairs. Combined SLAM and YOLO with ROS for navigation and obstacle avoidance using a RealSense camera, RPLidar, and IMU, plus an OGMD module to detect abnormal occupancy-grid features and switch navigation modes.

**Embedded Antenna Signals — SEAL, University of Washington**
Designed the signal-receiving module for the Heimdall ACU antenna system to detect weak electromagnetic interference (transformer, preamplifier, DAQ), targeting faint signal changes during meteorite events.
...
- [Undergraduate course projects](https://youtu.be/1jFw59NL1z8)
